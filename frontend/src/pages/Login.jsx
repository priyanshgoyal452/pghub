  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
        <div>
          <h2 className="text-center text-3xl font-extrabold text-gray-900">Sign in to PGhub</h2>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <button type="submit" className="w-full flex justify-center py-3 px-4 rounded-xl text-white bg-primary hover:bg-[#c71e24] font-bold transition-colors">Sign In</button>
        </form>
        
        <div className="mt-8 flex flex-col items-center border-t border-gray-100 pt-6">
          <p className="text-sm text-gray-500 font-bold mb-4">Or skip the email and instantly sign in</p>
          <GoogleLogin 
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          Don't have an account? <Link to="/register" className="font-bold text-primary hover:text-[#c71e24]">Register here</Link>
        </p>
      </div>
    </div>
  );
